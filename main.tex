...
Evaluation at each step of this iterative process involved a small number of testers as guided by \url(http://www.nngroup.com/articles/why-you-only-need-to-test-with-5-users/).
