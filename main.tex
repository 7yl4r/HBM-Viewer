...
\author{
  \IEEEauthorblockN{
    Tylar Murray\IEEEauthorrefmark{1},
    Daniel Rivera\IEEEauthorrefmark{2},
    Eric Hekler\IEEEauthorrefmark{3},
    Donna Spruijt-Metz\IEEEauthorrefmark{4},
    Andrew Raij\IEEEauthorrefmark{5}
  }
  \IEEEauthorblockA{
    \IEEEauthorrefmark{1}
  ...
  \IEEEauthorblockA{
    \IEEEauthorrefmark{2}
    Arizona State University Control Systems Engineering Laboratory
  }
  \IEEEauthorblockA{
    \IEEEauthorrefmark{3}
  ...
  \IEEEauthorblockA{
    \IEEEauthorrefmark{4}
    University of Southern California Center for Economic and Social Research Los Angeles, California
  }
  \IEEEauthorblockA{
    \IEEEauthorrefmark{5}
...
% This prototype was simply a quiz-style questionnaire which resulted in a model.
% This questionnaire was tested on a small user group of both behavioral scientists and graduate students, and was evaluated informally through discussion.
% 
...
%Use semi-physical and gray-box model optimization methods. 
...
% \begin{figure}[!t]
%   \centering
%   \includegraphics[width=0.4\columnwidth]{img/behaviorSim_process}  
